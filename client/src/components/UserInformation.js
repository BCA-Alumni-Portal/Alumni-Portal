...
export default function UserInformation() {
  ...
  return (
    <div className="text-left ml-8">
      <h1 className="text-5xl font-bold text-stone-600 mb-4">{isAuthenticated ? user.name : "user"}</h1>
      <div>
        ...
        <select className="select select-ghost select-lg w-full max-w-xs ml-4">
      ...
      <div>
        ...
        <input type="text" placeholder="Graduation year" className="input input-ghost input-lg w-full max-w-xs ml-4" />
      </div>
      <div>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 float-left mt-4">
          <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
        </svg>
        <input type="text" placeholder="Company" className="input input-ghost input-lg w-full max-w-xs ml-4" />
      </div>
