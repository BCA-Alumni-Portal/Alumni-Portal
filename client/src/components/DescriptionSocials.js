...
export default function DescriptionSocials() {
    ...
    return (
        <div>
            <div>
                <textarea className="textarea textarea-info w-full mt-4 focus:border-sky-400 focus:ring-0" placeholder="Tell us about yourself..." rows="4" onChange={(e) => changeDescription(e)}></textarea>
                {edited ?
