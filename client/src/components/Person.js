                        ...
                        <div className='col-span-3'>
                            <div>
                                {editingDesc ?
                                    ...
                                    :
                                    <div className='mt-4'>
                                        <p className="text-xl w-4/5 font-semibold text-stone-600 dark:text-white inline-block align-middle float-left text-left">{description == "" || description == null ? "Edit description" : description}</p>
