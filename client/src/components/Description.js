    ...
    return (
        <div>
            {editing ?
                ...
                :
                <div className='mt-4'>
                    <p class="text-xl w-11/12 font-semibold text-stone-600 dark:text-white inline-block align-middle float-left text-left">{description == "" ? "Tell us about yourself..." : description}</p>
