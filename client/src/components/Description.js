...
import { Circles, Grid, LineWave } from 'react-loader-spinner'
        ...
        return (
            <div>
                {editing ?
                    ...
                    :
                    <div className='mt-4'>
                        <p className="text-xl w-11/12 font-semibold text-stone-600 dark:text-white inline-block align-middle float-left text-left">{description == "" || description == null ? "Tell us about yourself..." : description}</p>
