...
function YearFilter(props) {
    ...
    return (
        <div className="px-10 flex grid grid-cols-3 gap-1 place-content-center">
            <div>
                <ul className="rounded-lg component-list block menu menu-horizontal bg-base-100 border border border-1 border-amber-300">
                    <li tabIndex="0">
                        <button className="rounded-lg component-list text-sm">Graduation Year</button>
                        <ul>
                            <div className="rounded-lg component-list bg-base-100 border border-1 border-amber-300">
